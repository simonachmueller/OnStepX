...
void BleGamepad::loop() {
  ...
  bleConnTest(); Y;
    ...
    void LED_STATE_A()
    {
      // if (LED_ENABLE == ON) digitalWrite(STATUS_LED_PIN, LED_STATUS_OFF_STATE);
      // else if (LED_ENABLE == REV) digitalWrite(STATUS_LED_PIN, LED_STATUS_ON_STATE);
    }
    void LED_STATE_B()
    {
      // if (LED_ENABLE == ON) digitalWrite(STATUS_LED_PIN, LED_STATUS_ON_STATE);
      // else if (LED_ENABLE == REV) digitalWrite(STATUS_LED_PIN, LED_STATUS_OFF_STATE);
    }
