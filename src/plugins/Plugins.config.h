...
#define PLUGIN1                    blegamepad //    OFF, Specify the class instance (same as plugin directory name) to enable.    Option
#include "blegamepad/BleGamepad.h"                //         Specify the header file to include the class.

#define PLUGIN1_COMMAND_PROCESSING    OFF //    OFF, Set to ON for plugins that allow command processing

#define PLUGIN2                       OFF
//#define PLUGIN2 website
